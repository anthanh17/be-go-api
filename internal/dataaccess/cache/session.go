...
type SessionCache interface {
	Get(ctx context.Context, id string) (SessionType, error)
	Set(ctx context.Context, id string, data SessionType) error
	// SetNX
...
func (s sessionCache) Get(ctx context.Context, id string) (SessionType, error) {
...
func (s sessionCache) Set(ctx context.Context, id string, data SessionType) error {
	logger := utils.LoggerWithContext(ctx, s.logger).With(zap.String("id", id))
